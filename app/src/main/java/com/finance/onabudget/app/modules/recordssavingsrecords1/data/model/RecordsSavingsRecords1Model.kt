package com.finance.onabudget.app.modules.recordssavingsrecords1.`data`.model

import com.finance.onabudget.app.R
import com.finance.onabudget.app.appcomponents.di.MyApp
import kotlin.String

data class RecordsSavingsRecords1Model(
  /**
  ...
  var txtDescription: String? =
      MyApp.getInstance().resources.getString(R.string.msg_congratulations3)
  ,
  /**
   * TODO Replace with dynamic value
   */
